...
class OpGraphModule:
    ...
    def __init__(self, json_path, lib_path, params_path):
        self.json_path = json_path
        self.lib_path = lib_path
        self.params_path = params_path

    def graph(self,  output_dtype=None, output_shape=None):
        """Get tvm op function wrapped as TensorFlow tensor to tensor function
        ...
        Func object that acts as TensorFlow tensor to tensor function.
        """
        return TensorGraph(self.json_path, self.lib_path, self.params_path, output_dtype, output_shape)
...
class TensorGraph:
    ...
    def __init__(self, json_path, lib_path, params_path, output_dtype, output_shape):
        self.lib_path = lib_path
        self.params_path = params_path
        self.output_dtype = output_dtype

        self.graph_json = open(json_path, "r").read()
