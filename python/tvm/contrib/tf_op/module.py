...
class OpGraphModule:
    ...
    def graph(self, output_dtype=None, output_shape=None):
        ...
        Func object that acts as TensorFlow tensor to tensor function.
        """
        return TensorGraph(self.lib_path, output_dtype, output_shape)
...
class TensorGraph:
    ...
    def __init__(self, lib_path, output_dtype, output_shape):
        self.lib_path = lib_path
        self.output_dtype = output_dtype
        ...
        self.module = self._load_platform_specific_library("libtvm_dso_op")
        self.tvm_dso_graph = self.module.tvm_dso_graph

    def apply(self, *params):
        return self.tvm_dso_graph(
            params,
            dynamic_output_shape=self.dynamic_output_shape,
            static_output_shape=self.static_output_shape,
            has_static_output_shape=self.has_static_output_shape,
